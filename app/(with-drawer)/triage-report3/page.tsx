...
const AI_MOCK_SUMMARY =
  "환자는 가슴 통증을 호소하며, 의식은 명료(Alert)합니다. 통증은 약 30분 전 갑자기 시작되었으며, 흉골 중앙부에서 좌측으로 방사되는 양상입니다. 활력징후는 BP 148/92, HR 102, SpO2 94%로 측정되었습니다. 과거력으로 고혈압 및 당뇨 복약 중이며, 심근경색 가능성을 고려하여 12-lead ECG 시행 및 응급의료센터 이송이 권고됩니다.";
